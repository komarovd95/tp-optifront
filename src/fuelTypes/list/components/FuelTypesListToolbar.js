...
class FuelTypesListToolbar extends Component {
  static propTypes = {
  ...
  dropdownItems = [
    {
      value: 'fuelTypeName,ASC',
      display: <span><i className="sort content ascending icon"/> Тип топлива</span>
    },
    {
      value: 'fuelTypeName,DESC',
      display: <span><i className="sort content descending icon"/> Тип топлива</span>
    },
    {
      value: 'cost,ASC',
      display: <span><i className="sort content ascending icon"/> Цена</span>
    },
    {
      value: 'cost,DESC',
      display: <span><i className="sort content descending icon"/> Цена</span>
    }
  ];
        ...
        <div className="four column row">
          ...
          <div className="column">
            <div className="ui fluid buttons">
              <Link to="/admin/fuelTypes/new" className="ui labeled icon button">
...
export default FuelTypesListToolbar;
